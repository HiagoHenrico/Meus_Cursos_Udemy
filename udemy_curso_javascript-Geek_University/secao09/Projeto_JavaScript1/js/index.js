// 1) Temos que referênciar o input
let input = document.querySelector('input[name=tarefa]');


// 2) Temos que referênciar o button
let btn = document.querySelector('#botao');


// 3) Temos que referênciar a lista
...
btn.onclick = function(){
   // 2) Precisamos capturar o valor digitado pelo usuario no input
    ...
    if(novaTarefa !== ""){
      ...
      // Limpar mensagens de error (spans)
      removerSpans();
...
function salvarDadosNoStorage(){
    ...
    // Todo navegador web possui está capacidade
