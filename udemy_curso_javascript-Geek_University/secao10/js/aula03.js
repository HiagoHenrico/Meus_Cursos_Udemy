...
btn.onclick= function(){
    ...
    // Abrir uma conexão (métodos http: GET, POST, PUT, DELETE)
    ...
    ajax.onreadystatechange = function(){
        ...
        /*
         ...
         ajax.readyState -> 3 => Carregando o ocrpo da requisição (conteúdo/dados)
        ...
        */
        ...
        if(ajax.readyState === 4){
            if(ajax.status === 200){
                ...
                // Adiciona texto ao span e o span à div
                spanNone.appendChild(txtNome);
                div.appendChild(spanNone);
